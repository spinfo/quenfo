...
public class ClassifyTextkernel {
	...
	// Pfad zur Input-DB
		static String inputDB = /* "D:/Daten/sqlite/SteA.db3"; */"classification/db/text_kernel_0705.db";
...
//			AbstractClassifier classifier = new ZoneKNNClassifier(true, 5, Distance.COSINUS);
//					
//					
